...
import type { EditorMedia } from "../../hooks/useQuillEditor";
...
const DEFAULT_ERROR = "Unable to update content. Please try again.";
...
const EditContentCard = ({
  ...
  const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (
    ...
    const payload: Record<string, unknown> = {
      ...
      data: {
        body: bodyHtml,
        excerpt: description || initialExcerpt || plainBody.slice(0, 180),
        media,
      },
    };
    ...
    setSubmitting(true);
    sendMessage("Saving changes…", "info");
    ...
    try {
      ...
      sendMessage("Content updated successfully.", "success");
      window.setTimeout(() => {
    ...
    <section className="flex flex-col gap-6 rounded-3xl bg-white p-8 shadow-xl ring-1 ring-slate-100">
      ...
      <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={submitting || !quillReady}
